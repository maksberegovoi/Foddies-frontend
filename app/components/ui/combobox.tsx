...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronDownIcon className="pointer-events-none size-4 text-dark" />
    </ComboboxPrimitive.Trigger>
  )
}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <XIcon className="pointer-events-none text-dark" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxInput({
  ...
  return (
    <InputGroup
      className={cn(
        "h-auto w-auto border-gray font-medium text-dark has-[[data-slot=input-group-control]:focus-visible]:border-gray has-[[data-slot=input-group-control]:focus-visible]:ring-0 [&_input]:px-3.5 [&_input]:py-3.5",
        className
      )}
    >
      <ComboboxPrimitive.Input
        render={
          <InputGroupInput
            disabled={disabled}
            className="text-sm placeholder:text-gray"
          />
        }
        {...props}
      />
      <InputGroupAddon align="inline-end" className="px-3.5 py-3">
        {showTrigger && (
          <InputGroupButton
            size="icon-xs"
            variant="ghost"
            ...
            className="border-transparent bg-transparent group-has-data-[slot=combobox-clear]/input-group:hidden hover:border-transparent hover:bg-transparent focus-visible:border-transparent focus-visible:ring-0 data-pressed:bg-transparent"
            disabled={disabled}
          />
        )}
